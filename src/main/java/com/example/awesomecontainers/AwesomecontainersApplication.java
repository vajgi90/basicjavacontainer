package com.example.awesomecontainers;

import com.example.awesomecontainers.entity.ThemeParkRide;
import com.example.awesomecontainers.repository.ThemeParkRideRepository;
...
public class AwesomecontainersApplication {

	public static void main(String[] args) {
		SpringApplication.run(AwesomecontainersApplication.class, args);
	}
